...
/**
 * Enhanced component for essay revision with improved UI/UX 
 * aligned with EssayStep3 component for consistency
 */
const RevisionRequest = ({ 
  ...
  const submitRevision = () => {
    ...
    // Simulate a bit of delay to match the UX of the original component
    setTimeout(() => {
      ...
      <header className="essay-top-nav">
        ...
        <div className="essay-nav-right">
          ...
          >
            ...
            <span className="essay-count-limit">{essay?.wordLimit || 500}</span>
        ...
        <div className="essay-editor-container">
          ...
          >
            {paragraphs.length > 0 ? (
              ...
              <div className="essay-no-content">
                <div className="essay-no-content-icon">
                  <FileText size={32} />
                </div>
          ...
          <aside className="essay-notes-panel">
            ...
            <div className="essay-notes-footer">
              ...
              <button 
                className={`essay-button-submit ${isSubmitting ? 'essay-button-submitting' : ''}`}
                onClick={submitRevision}
                disabled={allRevisionNotes.length === 0 || isSubmitting}
                aria-label="Submit edits"
              >
                <div className="essay-button-content">
                  {isSubmitting ? <CheckCircle size={16} /> : <Save size={16} />}
                  <span>{isSubmitting ? 'Processing Edits...' : 'Submit Edits'}</span>
                </div>
